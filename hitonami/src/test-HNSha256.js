...
ut.addCase("pPHesjhW HNSha256 null/empty",function(){
	ut.eq("hIuvKdzl",hn.Sha256.getHash(new hn.Data()),null);

	ut.eq("DTozGjbt",hn.Sha256.getHash(null),null);

	ut.eq("vNvonujO",hn.Sha256.getHash(hn.Data.fromHex("")),"e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855");
});
