...
ut.addCase("DVZQFRWM jsb.AssetManager from sample",function(){
...
ut.addCase("JBVPJMNY jsb.AssetManager basic",function(){
	cc.log("FMZJESIV jsb.fileUtils.getWritablePath() "+jsb.fileUtils.getWritablePath())
	
	var JBVPJMNY_manager;
	var JBVPJMNY_listener;

	JBVPJMNY_manager = new jsb.AssetsManager("res/000.manifest", jsb.fileUtils.getWritablePath()+"/manifest/000/");
